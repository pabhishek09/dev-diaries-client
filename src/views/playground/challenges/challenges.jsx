...
export default class ChallengeComponent extends Component {
  ...
  async componentDidMount() {
    ...
    this.getAllChallenges().then((data) => this.setState({ allChallenges: data }));
      ...
      <div>
        ...
        <div className="row challenges">
          <div className="left-pane col-sm-3">
            <Leaderboard leaderboard={this.state.leaderboard} userOnLeaderboard={this.state.userOnLeaderboard}></Leaderboard>
          </div>
