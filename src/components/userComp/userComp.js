    ...
    render() {
        ...
        return (
            <div className="row no-side-margins">
                <div className="col-sm-2 row-eq-height img-center">
                    {userDetails && <img src={userDetails.avatar_url} className="user-profile-img" alt="dev-diaries-logo" />}
                </div>
                <div className="col-sm-10 row-eq-height">

                    {userDetails &&
                        [<div>
                            <p className="user-name">{userDetails.login}</p>
                            <a className="user-github-link" href={userDetails.html_url}>{userDetails.html_url}</a>
